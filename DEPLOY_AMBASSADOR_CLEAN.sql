-- =====================================================
-- AMBASSADOR PROGRAM - COMPLETE DEPLOYMENT
-- =====================================================
...
-- Create ambassador_payouts table (BEFORE commission_transactions)
...
-- Create commission_transactions table (AFTER ambassador_payouts)
...
DO $$ 
BEGIN 
  RAISE NOTICE '✅ Ambassador Program tables created successfully!';
END $$;
