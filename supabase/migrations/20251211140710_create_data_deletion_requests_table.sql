...
-- 
-- This migration creates the data_deletion_requests table to track
-- all data deletion requests from Facebook and other providers.
-- Required by Meta's Platform Terms for Facebook app compliance.
--
...
COMMENT ON TABLE data_deletion_requests IS 'Tracks data deletion requests from Facebook and other OAuth providers. Required for Facebook app compliance.';
