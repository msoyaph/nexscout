...
CREATE INDEX IF NOT EXISTS idx_agent_skill_gaps_user_id ON public.agent_skill_gaps(user_id);
CREATE INDEX IF NOT EXISTS idx_ai_alerts_prospect_id ON public.ai_alerts(prospect_id);
CREATE INDEX IF NOT EXISTS idx_ai_closer_sessions_user_id ON public.ai_closer_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_ai_generated_messages_prospect_id ON public.ai_generated_messages(prospect_id);
CREATE INDEX IF NOT EXISTS idx_ai_generated_messages_user_id ON public.ai_generated_messages(user_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_mentor_sessions_prospect_id ON public.ai_mentor_sessions(prospect_id);
CREATE INDEX IF NOT EXISTS idx_ai_mentor_sessions_user_id ON public.ai_mentor_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_ai_message_sequences_prospect_id ON public.ai_message_sequences(prospect_id);
CREATE INDEX IF NOT EXISTS idx_ai_tasks_prospect_id ON public.ai_tasks(prospect_id);
